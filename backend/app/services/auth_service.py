...
class AuthService:
    ...
    async def register_sms(self, phone: str, first_name: str, last_name: str, email: str | None) -> str:
        ...
        return code if not sent else ""  # dev: return code if SMS failed
